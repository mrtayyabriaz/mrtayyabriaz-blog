  ...
  return (
    <>
      ...
      {Loggedin ?
        // ================= Logged In ( START ) ======================= 
        <div className="w-fit">
          <div className="mx-2 rounded-md border-2 border-blue-900  overflow-hidden">
            <div className="p-2 bg-slate-300">
              {userData.emailVerification ? <div className="text-green-600 font-bold">Verified</div> : <div className=" text-red-800">Not Verified</div>}
            </div>
            <div className="p-3">
              <p className='card-text font-bold text-2xl'>{userData.name}</p>
              <h5 className=' text-lg  '>EMail: {userData.email}</h5>
              {/* <p className='card-text'>ID: {userData.$id}</p> */}
              <button className='w-auto bg-purple-800 text-white rounded-md px-3 py-1 mt-2'
                onClick={() => {
                  navigate('/');
                }}>Home</button>
            </div>
          ...
          <section>
            <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
              <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
                ...
                <div className="message">{loginStatus ?
                  ...
                  >
                    <div class="flex items-start gap-4">
                      ...
                      <div class="flex-1">
                        <strong class="block font-medium text-gray-900 dark:text-white"> Login Success </strong>

                        <p class="mt-1 text-sm text-gray-700 dark:text-gray-200">
                          Your have been logged into your account.
                        </p>
                      </div>
                ...
                <form action="#" method="POST" className="mt-8" onSubmit={handleSubmit(login_form)}>
