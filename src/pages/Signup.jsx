...
function Signup() {
  ...
  return (
    ...
    {/* <div classNameName="container">
      <div classNameName="login-form mx-auto">
        <h1 classNameName='mb-3'>Signup</h1>
        ...
        <form onSubmit={handleSubmit(login_form)}>
          ...
          <button type="submit" classNameName='btn btn-primary'>Signup</button>
        </form>
      </div>
    </div> */}
      ...
      <section>
      {error && <div classNameName="error text-red-700">{error}</div>}
        <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            ...
            <form onSubmit={handleSubmit(login_form)} className="mt-8">
